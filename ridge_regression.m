...
%       includes the i-th coefficient, reject null hypothesis or not, p-value
%   cv_results: the mse from cv of each lambda
%================================================
function [b,LRT_result,cv_results,mse,r_sq,best_lambda] = ridge_regression(X,y,lambdas,opts)
